...
# 安装Visual Studio
RUN Invoke-WebRequest -OutFile C:\\vs_installer.exe -Uri https://aka.ms/vs/17/release/vs_community.exe; \
    Start-Process C:\\vs_installer.exe -ArgumentList '--quiet --wait --norestart --nocache \
